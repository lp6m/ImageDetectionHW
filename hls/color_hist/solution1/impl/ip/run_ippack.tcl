...
set Library     "hls"
set IPName      "color_hist"
set Version     "1.0"
set DisplayName "Color_hist"
set Revision    "1811271535"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS s_axi_SPECS m_axi_INPUT_IMAGE m_axi_FEATURE"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_FEATURE {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_FEATURE"
        data_width "32"
        param_prefix "C_M_AXI_FEATURE"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 6 machine 64 combinational 0 latency 3188 II x}
