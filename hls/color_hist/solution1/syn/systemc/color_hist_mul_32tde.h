...
#ifndef __color_hist_mul_32tde__HH__
#define __color_hist_mul_32tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(color_hist_mul_32tde) {
    ...
    SC_CTOR(color_hist_mul_32tde):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
