...
#ifndef __color_hist_mul_muvdy__HH__
#define __color_hist_mul_muvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(color_hist_mul_muvdy) {
    ...
    SC_CTOR(color_hist_mul_muvdy):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
