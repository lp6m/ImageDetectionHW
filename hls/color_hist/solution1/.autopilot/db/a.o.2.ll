...
@.str9 = private unnamed_addr constant [11 x i8] c"read_input\00", align 1 ; [#uses=3 type=[11 x i8]*]
...
@.str13 = private unnamed_addr constant [7 x i8] c"loop_i\00", align 1 ; [#uses=3 type=[7 x i8]*]
@.str12 = private unnamed_addr constant [7 x i8] c"loop_x\00", align 1 ; [#uses=3 type=[7 x i8]*]
@.str11 = private unnamed_addr constant [7 x i8] c"loop_y\00", align 1 ; [#uses=3 type=[7 x i8]*]
...
; [#uses=0]
define void @color_hist([3 x i32]* %specs, i8* %imageptr, i16* %feature) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap([3 x i32]* %specs) nounwind, !map !2663
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %imageptr) nounwind, !map !2669
  call void (...)* @_ssdm_op_SpecBitsMap(i16* %feature) nounwind, !map !2673
  %specs.addr = getelementptr [3 x i32]* %specs, i64 0, i64 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @color_hist.str) nounwind
  %"image_buffer[0]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[1]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[2]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[3]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[4]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[5]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[6]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[7]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[8]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[9]" = alloca [96 x i8], align 1  ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[10]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[11]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[12]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[13]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[14]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %"image_buffer[15]" = alloca [96 x i8], align 1 ; [#uses=2 type=[96 x i8]*]
  %rst = alloca [36 x i16], align 16              ; [#uses=3 type=[36 x i16]*]
  call void @llvm.dbg.declare(metadata !{[36 x i16]* %rst}, metadata !2677), !dbg !2682 ; [debug line = 51:17] [debug variable = rst]
  call void @llvm.dbg.value(metadata !{[3 x i32]* %specs}, i64 0, metadata !2683), !dbg !2687 ; [debug line = 37:21] [debug variable = specs]
  call void @llvm.dbg.value(metadata !{i8* %imageptr}, i64 0, metadata !2688), !dbg !2689 ; [debug line = 37:46] [debug variable = imageptr]
  call void @llvm.dbg.value(metadata !{i16* %feature}, i64 0, metadata !2690), !dbg !2691 ; [debug line = 37:72] [debug variable = feature]
  call void (...)* @_ssdm_op_SpecInterface([3 x i32]* %specs, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 16, [6 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [12 x i8]* @.str3, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2692 ; [debug line = 39:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %imageptr, [6 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [12 x i8]* @.str5, [6 x i8]* @.str6, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2693 ; [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %feature, [6 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [8 x i8]* @.str7, [6 x i8]* @.str6, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2694 ; [debug line = 41:1]
  %y = load i32* %specs.addr, align 4, !dbg !2695 ; [#uses=1 type=i32] [debug line = 42:18]
  call void @llvm.dbg.value(metadata !{i32 %y}, i64 0, metadata !2696), !dbg !2695 ; [debug line = 42:18] [debug variable = y]
  %specs.addr.1 = getelementptr [3 x i32]* %specs, i64 0, i64 1, !dbg !2697 ; [#uses=1 type=i32*] [debug line = 43:18]
  %x = load i32* %specs.addr.1, align 4, !dbg !2697 ; [#uses=1 type=i32] [debug line = 43:18]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !2698), !dbg !2697 ; [debug line = 43:18] [debug variable = x]
  %specs.addr.2 = getelementptr [3 x i32]* %specs, i64 0, i64 2, !dbg !2699 ; [#uses=1 type=i32*] [debug line = 44:31]
  %original_width = load i32* %specs.addr.2, align 4, !dbg !2699 ; [#uses=1 type=i32] [debug line = 44:31]
  call void @llvm.dbg.value(metadata !{i32 %original_width}, i64 0, metadata !2700), !dbg !2699 ; [debug line = 44:31] [debug variable = original_width]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[0]"}, metadata !2701), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[0]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[1]"}, metadata !2707), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[1]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[2]"}, metadata !2708), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[2]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[3]"}, metadata !2709), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[3]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[4]"}, metadata !2710), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[4]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[5]"}, metadata !2711), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[5]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[6]"}, metadata !2712), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[6]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[7]"}, metadata !2713), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[7]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[8]"}, metadata !2714), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[8]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[9]"}, metadata !2715), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[9]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[10]"}, metadata !2716), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[10]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[11]"}, metadata !2717), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[11]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[12]"}, metadata !2718), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[12]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[13]"}, metadata !2719), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[13]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[14]"}, metadata !2720), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[14]]
  call void @llvm.dbg.declare(metadata !{[96 x i8]* %"image_buffer[15]"}, metadata !2721), !dbg !2706 ; [debug line = 45:16] [debug variable = image_buffer[15]]
  br label %1, !dbg !2722                         ; [debug line = 47:26]

; <label>:1                                       ; preds = %burst.rd.end, %0
  %i = phi i5 [ 0, %0 ], [ %i.1, %burst.rd.end ]  ; [#uses=5 type=i5]
  %i.cast7 = zext i5 %i to i32, !dbg !2722        ; [#uses=1 type=i32] [debug line = 47:26]
  %i.cast6 = zext i5 %i to i9, !dbg !2722         ; [#uses=1 type=i9] [debug line = 47:26]
  %i.cast5 = zext i5 %i to i11, !dbg !2722        ; [#uses=1 type=i11] [debug line = 47:26]
  %exitcond = icmp eq i5 %i, -16, !dbg !2722      ; [#uses=1 type=i1] [debug line = 47:26]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond, label %meminst.preheader, label %3, !dbg !2722 ; [debug line = 47:26]

meminst.preheader:                                ; preds = %1
  br label %meminst, !dbg !2724                   ; [debug line = 51:32]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @.str9) nounwind, !dbg !2725 ; [debug line = 47:41]
  %tmp.10 = call i32 (...)* @_ssdm_op_SpecRegionBegin([11 x i8]* @.str9) nounwind, !dbg !2725 ; [#uses=1 type=i32] [debug line = 47:41]
  %tmp = add nsw i32 %i.cast7, %y, !dbg !2727     ; [#uses=1 type=i32] [debug line = 48:50]
  %tmp.1 = mul nsw i32 %tmp, %original_width, !dbg !2727 ; [#uses=1 type=i32] [debug line = 48:50]
  %tmp.2 = add nsw i32 %tmp.1, %x, !dbg !2727     ; [#uses=2 type=i32] [debug line = 48:50]
  %_shl = shl i32 %tmp.2, 2, !dbg !2727           ; [#uses=1 type=i32] [debug line = 48:50]
  %offset = sub i32 %_shl, %tmp.2, !dbg !2727     ; [#uses=2 type=i32] [debug line = 48:50]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !2728), !dbg !2727 ; [debug line = 48:50] [debug variable = offset]
  %tmp.3 = sext i32 %offset to i64, !dbg !2729    ; [#uses=1 type=i64] [debug line = 49:3]
  %imageptr.addr.1 = getelementptr inbounds i8* %imageptr, i64 %tmp.3, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %_shl3 = shl i11 %i.cast5, 7                    ; [#uses=1 type=i11]
  %_shl3.cast = zext i11 %_shl3 to i12            ; [#uses=1 type=i12]
  %_shl4 = shl i9 %i.cast6, 5                     ; [#uses=1 type=i9]
  %_shl4.cast = zext i9 %_shl4 to i12             ; [#uses=1 type=i12]
  %tmp.8 = sub i12 %_shl3.cast, %_shl4.cast       ; [#uses=1 type=i12]
  %tmp.8.cast.cast = sext i12 %tmp.8 to i14       ; [#uses=1 type=i14]
  br label %burst.rd.header

burst.rd.header:                                  ; preds = %burst.rd.body21, %3
  %indvar = phi i7 [ 0, %3 ], [ %indvar.next, %burst.rd.body21 ] ; [#uses=4 type=i7]
  %indvar.cast4.cast = zext i7 %indvar to i14     ; [#uses=1 type=i14]
  %indvar.cast3 = zext i7 %indvar to i32          ; [#uses=1 type=i32]
  %exitcond1 = icmp eq i7 %indvar, -32            ; [#uses=1 type=i1]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 96, i64 96, i64 96) nounwind ; [#uses=0 type=i32]
...
burst.rd.body:                                    ; preds = %burst.rd.header
  ...
  %5 = call i32 (...)* @_ssdm_op_SpecBurst(i8* %imageptr.addr.1, i32 1, i32 96, i32 1) nounwind ; [#uses=0 type=i32]
  ...
  %imageptr.addr = add i32 %indvar.cast3, %offset ; [#uses=1 type=i32]
  %tmp.7 = sext i32 %imageptr.addr to i64, !dbg !2729 ; [#uses=1 type=i64] [debug line = 49:3]
  %imageptr.addr.2 = getelementptr i8* %imageptr, i64 %tmp.7, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %imageptr.load = load i8* %imageptr.addr.2, align 1, !dbg !2729 ; [#uses=16 type=i8] [debug line = 49:3]
  %tmp.9 = add i14 %indvar.cast4.cast, %tmp.8.cast.cast ; [#uses=2 type=i14]
  %tmp. = udiv i14 %tmp.9, 96                     ; [#uses=1 type=i14]
  %tmp.6 = urem i14 %tmp.9, 96                    ; [#uses=1 type=i14]
  %tmp.11 = zext i14 %tmp.6 to i64, !dbg !2729    ; [#uses=16 type=i64] [debug line = 49:3]
  %tmp..t = trunc i14 %tmp. to i4                 ; [#uses=1 type=i4]
  %"image_buffer[0].addr" = getelementptr [96 x i8]* %"image_buffer[0]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[1].addr" = getelementptr [96 x i8]* %"image_buffer[1]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[2].addr" = getelementptr [96 x i8]* %"image_buffer[2]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[3].addr" = getelementptr [96 x i8]* %"image_buffer[3]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[4].addr" = getelementptr [96 x i8]* %"image_buffer[4]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[5].addr" = getelementptr [96 x i8]* %"image_buffer[5]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[6].addr" = getelementptr [96 x i8]* %"image_buffer[6]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[7].addr" = getelementptr [96 x i8]* %"image_buffer[7]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[8].addr" = getelementptr [96 x i8]* %"image_buffer[8]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[9].addr" = getelementptr [96 x i8]* %"image_buffer[9]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[10].addr" = getelementptr [96 x i8]* %"image_buffer[10]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[11].addr" = getelementptr [96 x i8]* %"image_buffer[11]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[12].addr" = getelementptr [96 x i8]* %"image_buffer[12]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[13].addr" = getelementptr [96 x i8]* %"image_buffer[13]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[14].addr" = getelementptr [96 x i8]* %"image_buffer[14]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  %"image_buffer[15].addr" = getelementptr [96 x i8]* %"image_buffer[15]", i64 0, i64 %tmp.11, !dbg !2729 ; [#uses=1 type=i8*] [debug line = 49:3]
  switch i4 %tmp..t, label %branch15 [
    i4 0, label %branch0
    i4 1, label %branch1
    i4 2, label %branch2
    i4 3, label %branch3
...
burst.rd.end:                                     ; preds = %burst.rd.header
  %6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @.str9, i32 %tmp.10) nounwind, !dbg !2730 ; [#uses=0 type=i32] [debug line = 50:2]
  %i.1 = add i5 %i, 1, !dbg !2731                 ; [#uses=1 type=i5] [debug line = 47:36]
  call void @llvm.dbg.value(metadata !{i5 %i.1}, i64 0, metadata !2732), !dbg !2731 ; [debug line = 47:36] [debug variable = i]
  br label %1, !dbg !2731                         ; [debug line = 47:36]

meminst:                                          ; preds = %meminst, %meminst.preheader
  %invdar = phi i6 [ %indvarinc, %meminst ], [ 0, %meminst.preheader ] ; [#uses=3 type=i6]
  %indvarinc = add i6 %invdar, 1, !dbg !2724      ; [#uses=1 type=i6] [debug line = 51:32]
  %tmp.4 = zext i6 %invdar to i64, !dbg !2724     ; [#uses=1 type=i64] [debug line = 51:32]
  %rst.addr = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.4, !dbg !2724 ; [#uses=1 type=i16*] [debug line = 51:32]
  store i16 0, i16* %rst.addr, align 2, !dbg !2724 ; [debug line = 51:32]
  %tmp.5 = icmp eq i6 %invdar, -29, !dbg !2724    ; [#uses=1 type=i1] [debug line = 51:32]
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @memset_rst.str)
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 36, i64 36, i64 36) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.5, label %8, label %meminst, !dbg !2724 ; [debug line = 51:32]

; <label>:8                                       ; preds = %meminst
  call fastcc void @calc_hist([96 x i8]* %"image_buffer[0]", [96 x i8]* %"image_buffer[1]", [96 x i8]* %"image_buffer[2]", [96 x i8]* %"image_buffer[3]", [96 x i8]* %"image_buffer[4]", [96 x i8]* %"image_buffer[5]", [96 x i8]* %"image_buffer[6]", [96 x i8]* %"image_buffer[7]", [96 x i8]* %"image_buffer[8]", [96 x i8]* %"image_buffer[9]", [96 x i8]* %"image_buffer[10]", [96 x i8]* %"image_buffer[11]", [96 x i8]* %"image_buffer[12]", [96 x i8]* %"image_buffer[13]", [96 x i8]* %"image_buffer[14]", [96 x i8]* %"image_buffer[15]", [36 x i16]* %rst) nounwind, !dbg !2733 ; [debug line = 52:2]
  br label %burst.wr.header

burst.wr.header:                                  ; preds = %burst.wr.body, %8
  %indvar8 = phi i6 [ 0, %8 ], [ %indvar.next9, %burst.wr.body ] ; [#uses=3 type=i6]
  %exitcond2 = icmp eq i6 %indvar8, -28           ; [#uses=1 type=i1]
  %9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 36, i64 36, i64 36) nounwind ; [#uses=0 type=i32]
...
burst.wr.body:                                    ; preds = %burst.wr.header
  ...
  %10 = call i32 (...)* @_ssdm_op_SpecBurst(i16* %feature, i32 0, i32 36, i32 1) nounwind ; [#uses=0 type=i32]
  ...
  %tmp.12 = zext i6 %indvar8 to i64, !dbg !2734   ; [#uses=2 type=i64] [debug line = 53:2]
  %rst.addr.1 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.12, !dbg !2734 ; [#uses=1 type=i16*] [debug line = 53:2]
  %rst.load = load i16* %rst.addr.1, align 2, !dbg !2734 ; [#uses=1 type=i16] [debug line = 53:2]
  %feature.addr = getelementptr i16* %feature, i64 %tmp.12, !dbg !2734 ; [#uses=1 type=i16*] [debug line = 53:2]
  store i16 %rst.load, i16* %feature.addr, align 2, !dbg !2734 ; [debug line = 53:2]
...
branch0:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[0].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch1:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[1].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch2:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[2].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch3:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[3].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch4:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[4].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch5:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[5].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch6:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[6].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch7:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[7].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch8:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[8].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch9:                                          ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[9].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch10:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[10].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch11:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[11].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch12:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[12].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch13:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[13].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch14:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[14].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]

branch15:                                         ; preds = %burst.rd.body
  store i8 %imageptr.load, i8* %"image_buffer[15].addr", align 1, !dbg !2729 ; [debug line = 49:3]
  br label %burst.rd.body21, !dbg !2729           ; [debug line = 49:3]
}

; [#uses=1]
define internal fastcc void @calc_hist([96 x i8]* nocapture %"image_buffer[0]", [96 x i8]* nocapture %"image_buffer[1]", [96 x i8]* nocapture %"image_buffer[2]", [96 x i8]* nocapture %"image_buffer[3]", [96 x i8]* nocapture %"image_buffer[4]", [96 x i8]* nocapture %"image_buffer[5]", [96 x i8]* nocapture %"image_buffer[6]", [96 x i8]* nocapture %"image_buffer[7]", [96 x i8]* nocapture %"image_buffer[8]", [96 x i8]* nocapture %"image_buffer[9]", [96 x i8]* nocapture %"image_buffer[10]", [96 x i8]* nocapture %"image_buffer[11]", [96 x i8]* nocapture %"image_buffer[12]", [96 x i8]* nocapture %"image_buffer[13]", [96 x i8]* nocapture %"image_buffer[14]", [96 x i8]* nocapture %"image_buffer[15]", [36 x i16]* nocapture %rst) {
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[0]"}, i64 0, metadata !2736), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[0]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[1]"}, i64 0, metadata !2739), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[1]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[2]"}, i64 0, metadata !2740), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[2]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[3]"}, i64 0, metadata !2741), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[3]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[4]"}, i64 0, metadata !2742), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[4]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[5]"}, i64 0, metadata !2743), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[5]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[6]"}, i64 0, metadata !2744), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[6]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[7]"}, i64 0, metadata !2745), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[7]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[8]"}, i64 0, metadata !2746), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[8]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[9]"}, i64 0, metadata !2747), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[9]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[10]"}, i64 0, metadata !2748), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[10]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[11]"}, i64 0, metadata !2749), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[11]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[12]"}, i64 0, metadata !2750), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[12]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[13]"}, i64 0, metadata !2751), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[13]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[14]"}, i64 0, metadata !2752), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[14]]
  call void @llvm.dbg.value(metadata !{[96 x i8]* %"image_buffer[15]"}, i64 0, metadata !2753), !dbg !2738 ; [debug line = 14:37] [debug variable = image_buffer[15]]
  call void @llvm.dbg.value(metadata !{[36 x i16]* %rst}, i64 0, metadata !2754), !dbg !2755 ; [debug line = 14:76] [debug variable = rst]
  br label %1, !dbg !2756                         ; [debug line = 15:22]

; <label>:1                                       ; preds = %36, %0
  %y = phi i5 [ 0, %0 ], [ %y.1, %36 ]            ; [#uses=3 type=i5]
  %exitcond2 = icmp eq i5 %y, -16, !dbg !2756     ; [#uses=1 type=i1] [debug line = 15:22]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %38, label %3, !dbg !2756 ; [debug line = 15:22]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([7 x i8]* @.str11) nounwind, !dbg !2759 ; [debug line = 15:37]
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([7 x i8]* @.str11), !dbg !2759 ; [#uses=1 type=i32] [debug line = 15:37]
  %y.t = trunc i5 %y to i4                        ; [#uses=1 type=i4]
  br label %4, !dbg !2761                         ; [debug line = 16:23]

; <label>:4                                       ; preds = %34, %3
  %x = phi i6 [ 0, %3 ], [ %x.1, %34 ]            ; [#uses=4 type=i6]
  %x.cast4 = zext i6 %x to i8, !dbg !2761         ; [#uses=1 type=i8] [debug line = 16:23]
  %x.cast = zext i6 %x to i7, !dbg !2761          ; [#uses=1 type=i7] [debug line = 16:23]
  %exitcond1 = icmp eq i6 %x, -32, !dbg !2761     ; [#uses=1 type=i1] [debug line = 16:23]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 32, i64 32, i64 32) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %36, label %6, !dbg !2761 ; [debug line = 16:23]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([7 x i8]* @.str12) nounwind, !dbg !2763 ; [debug line = 16:38]
  %tmp.11 = call i32 (...)* @_ssdm_op_SpecRegionBegin([7 x i8]* @.str12), !dbg !2763 ; [#uses=1 type=i32] [debug line = 16:38]
  %_shl = shl i7 %x.cast, 2, !dbg !2765           ; [#uses=1 type=i7] [debug line = 19:44]
  %_shl.cast = zext i7 %_shl to i8, !dbg !2765    ; [#uses=1 type=i8] [debug line = 19:44]
  %tmp. = sub i8 %_shl.cast, %x.cast4, !dbg !2765 ; [#uses=1 type=i8] [debug line = 19:44]
  br label %7, !dbg !2768                         ; [debug line = 17:24]

; <label>:7                                       ; preds = %32, %6
  %i = phi i2 [ 0, %6 ], [ %i.2, %32 ]            ; [#uses=5 type=i2]
  %i.cast3 = zext i2 %i to i8, !dbg !2768         ; [#uses=1 type=i8] [debug line = 17:24]
  %i.cast2 = zext i2 %i to i4, !dbg !2768         ; [#uses=11 type=i4] [debug line = 17:24]
  %i.cast1 = zext i2 %i to i6, !dbg !2768         ; [#uses=11 type=i6] [debug line = 17:24]
  %exitcond = icmp eq i2 %i, -1, !dbg !2768       ; [#uses=1 type=i1] [debug line = 17:24]
  %8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) ; [#uses=0 type=i32]
  br i1 %exitcond, label %34, label %9, !dbg !2768 ; [debug line = 17:24]

; <label>:9                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName([7 x i8]* @.str13) nounwind, !dbg !2769 ; [debug line = 17:38]
  %tmp.12 = call i32 (...)* @_ssdm_op_SpecRegionBegin([7 x i8]* @.str13), !dbg !2769 ; [#uses=1 type=i32] [debug line = 17:38]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2770 ; [debug line = 18:1]
  %tmp.13 = add i8 %i.cast3, %tmp., !dbg !2765    ; [#uses=1 type=i8] [debug line = 19:44]
  %tmp.13.cast = sext i8 %tmp.13 to i32, !dbg !2765 ; [#uses=1 type=i32] [debug line = 19:44]
  %tmp.14 = zext i32 %tmp.13.cast to i64, !dbg !2765 ; [#uses=16 type=i64] [debug line = 19:44]
  %"image_buffer[0].addr" = getelementptr [96 x i8]* %"image_buffer[0]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[0].load" = load i8* %"image_buffer[0].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[1].addr" = getelementptr [96 x i8]* %"image_buffer[1]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[1].load" = load i8* %"image_buffer[1].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[2].addr" = getelementptr [96 x i8]* %"image_buffer[2]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[2].load" = load i8* %"image_buffer[2].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[3].addr" = getelementptr [96 x i8]* %"image_buffer[3]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[3].load" = load i8* %"image_buffer[3].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[4].addr" = getelementptr [96 x i8]* %"image_buffer[4]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[4].load" = load i8* %"image_buffer[4].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[5].addr" = getelementptr [96 x i8]* %"image_buffer[5]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[5].load" = load i8* %"image_buffer[5].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[6].addr" = getelementptr [96 x i8]* %"image_buffer[6]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[6].load" = load i8* %"image_buffer[6].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[7].addr" = getelementptr [96 x i8]* %"image_buffer[7]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[7].load" = load i8* %"image_buffer[7].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[8].addr" = getelementptr [96 x i8]* %"image_buffer[8]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[8].load" = load i8* %"image_buffer[8].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[9].addr" = getelementptr [96 x i8]* %"image_buffer[9]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[9].load" = load i8* %"image_buffer[9].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[10].addr" = getelementptr [96 x i8]* %"image_buffer[10]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[10].load" = load i8* %"image_buffer[10].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[11].addr" = getelementptr [96 x i8]* %"image_buffer[11]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[11].load" = load i8* %"image_buffer[11].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[12].addr" = getelementptr [96 x i8]* %"image_buffer[12]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[12].load" = load i8* %"image_buffer[12].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[13].addr" = getelementptr [96 x i8]* %"image_buffer[13]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[13].load" = load i8* %"image_buffer[13].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[14].addr" = getelementptr [96 x i8]* %"image_buffer[14]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[14].load" = load i8* %"image_buffer[14].addr", align 1 ; [#uses=1 type=i8]
  %"image_buffer[15].addr" = getelementptr [96 x i8]* %"image_buffer[15]", i64 0, i64 %tmp.14 ; [#uses=1 type=i8*]
  %"image_buffer[15].load" = load i8* %"image_buffer[15].addr", align 1 ; [#uses=1 type=i8]
  %pix = call i8 @_ssdm_op_Mux.ap_auto.16i8.i4(i8 %"image_buffer[0].load", i8 %"image_buffer[1].load", i8 %"image_buffer[2].load", i8 %"image_buffer[3].load", i8 %"image_buffer[4].load", i8 %"image_buffer[5].load", i8 %"image_buffer[6].load", i8 %"image_buffer[7].load", i8 %"image_buffer[8].load", i8 %"image_buffer[9].load", i8 %"image_buffer[10].load", i8 %"image_buffer[11].load", i8 %"image_buffer[12].load", i8 %"image_buffer[13].load", i8 %"image_buffer[14].load", i8 %"image_buffer[15].load", i4 %y.t) ; [#uses=11 type=i8]
  call void @llvm.dbg.value(metadata !{i8 %pix}, i64 0, metadata !2771), !dbg !2765 ; [debug line = 19:44] [debug variable = pix]
  %tmp.15 = icmp ult i8 %pix, 21, !dbg !2772      ; [#uses=1 type=i1] [debug line = 20:5]
  br i1 %tmp.15, label %10, label %11, !dbg !2772 ; [debug line = 20:5]

; <label>:10                                      ; preds = %9
  %_shl1 = shl nuw i6 %i.cast1, 4, !dbg !2773     ; [#uses=1 type=i6] [debug line = 20:45]
  %_shl1.cast = zext i6 %_shl1 to i7, !dbg !2773  ; [#uses=1 type=i7] [debug line = 20:45]
  %_shl2 = shl nuw i4 %i.cast2, 2, !dbg !2773     ; [#uses=1 type=i4] [debug line = 20:45]
  %_shl2.cast = zext i4 %_shl2 to i7, !dbg !2773  ; [#uses=1 type=i7] [debug line = 20:45]
  %tmp.16 = sub i7 %_shl1.cast, %_shl2.cast, !dbg !2773 ; [#uses=1 type=i7] [debug line = 20:45]
  %tmp.16.cast = sext i7 %tmp.16 to i32, !dbg !2773 ; [#uses=1 type=i32] [debug line = 20:45]
  %tmp.17 = zext i32 %tmp.16.cast to i64, !dbg !2773 ; [#uses=1 type=i64] [debug line = 20:45]
  %rst.addr = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.17, !dbg !2773 ; [#uses=2 type=i16*] [debug line = 20:45]
  %rst.load = load i16* %rst.addr, align 2, !dbg !2773 ; [#uses=1 type=i16] [debug line = 20:45]
  %tmp.18 = add i16 %rst.load, 1, !dbg !2773      ; [#uses=1 type=i16] [debug line = 20:45]
  store i16 %tmp.18, i16* %rst.addr, align 2, !dbg !2773 ; [debug line = 20:45]
  br label %32, !dbg !2773                        ; [debug line = 20:45]

; <label>:11                                      ; preds = %9
  %tmp.19 = icmp ult i8 %pix, 42, !dbg !2774      ; [#uses=1 type=i1] [debug line = 21:10]
  br i1 %tmp.19, label %12, label %._crit_edge, !dbg !2774 ; [debug line = 21:10]

; <label>:12                                      ; preds = %11
  %_shl3 = shl nuw i6 %i.cast1, 4, !dbg !2775     ; [#uses=1 type=i6] [debug line = 21:50]
  %_shl3.cast = zext i6 %_shl3 to i7, !dbg !2775  ; [#uses=1 type=i7] [debug line = 21:50]
  %_shl4 = shl nuw i4 %i.cast2, 2, !dbg !2775     ; [#uses=1 type=i4] [debug line = 21:50]
  %_shl4.cast = zext i4 %_shl4 to i7, !dbg !2775  ; [#uses=1 type=i7] [debug line = 21:50]
  %tmp.20 = sub i7 %_shl3.cast, %_shl4.cast, !dbg !2775 ; [#uses=1 type=i7] [debug line = 21:50]
  %tmp.20.cast = sext i7 %tmp.20 to i32, !dbg !2775 ; [#uses=1 type=i32] [debug line = 21:50]
  %tmp.21 = or i32 %tmp.20.cast, 1, !dbg !2775    ; [#uses=1 type=i32] [debug line = 21:50]
  %tmp.22 = zext i32 %tmp.21 to i64, !dbg !2775   ; [#uses=1 type=i64] [debug line = 21:50]
  %rst.addr.2 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.22, !dbg !2775 ; [#uses=2 type=i16*] [debug line = 21:50]
  %rst.load.1 = load i16* %rst.addr.2, align 2, !dbg !2775 ; [#uses=1 type=i16] [debug line = 21:50]
  %tmp.23 = add i16 %rst.load.1, 1, !dbg !2775    ; [#uses=1 type=i16] [debug line = 21:50]
  store i16 %tmp.23, i16* %rst.addr.2, align 2, !dbg !2775 ; [debug line = 21:50]
  br label %31, !dbg !2775                        ; [debug line = 21:50]

._crit_edge:                                      ; preds = %11
  %tmp.24 = icmp ult i8 %pix, 64, !dbg !2776      ; [#uses=1 type=i1] [debug line = 22:10]
  br i1 %tmp.24, label %13, label %._crit_edge4, !dbg !2776 ; [debug line = 22:10]

; <label>:13                                      ; preds = %._crit_edge
  %_shl5 = shl nuw i6 %i.cast1, 4, !dbg !2777     ; [#uses=1 type=i6] [debug line = 22:50]
  %_shl5.cast = zext i6 %_shl5 to i7, !dbg !2777  ; [#uses=1 type=i7] [debug line = 22:50]
  %_shl6 = shl nuw i4 %i.cast2, 2, !dbg !2777     ; [#uses=1 type=i4] [debug line = 22:50]
  %_shl6.cast = zext i4 %_shl6 to i7, !dbg !2777  ; [#uses=1 type=i7] [debug line = 22:50]
  %tmp.25 = sub i7 %_shl5.cast, %_shl6.cast, !dbg !2777 ; [#uses=1 type=i7] [debug line = 22:50]
  %tmp.26 = or i7 %tmp.25, 2, !dbg !2777          ; [#uses=1 type=i7] [debug line = 22:50]
  %tmp.26.cast = sext i7 %tmp.26 to i32, !dbg !2777 ; [#uses=1 type=i32] [debug line = 22:50]
  %tmp.27 = zext i32 %tmp.26.cast to i64, !dbg !2777 ; [#uses=1 type=i64] [debug line = 22:50]
  %rst.addr.3 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.27, !dbg !2777 ; [#uses=2 type=i16*] [debug line = 22:50]
  %rst.load.2 = load i16* %rst.addr.3, align 2, !dbg !2777 ; [#uses=1 type=i16] [debug line = 22:50]
  %tmp.28 = add i16 %rst.load.2, 1, !dbg !2777    ; [#uses=1 type=i16] [debug line = 22:50]
  store i16 %tmp.28, i16* %rst.addr.3, align 2, !dbg !2777 ; [debug line = 22:50]
  br label %30, !dbg !2777                        ; [debug line = 22:50]

._crit_edge4:                                     ; preds = %._crit_edge
  %tmp.29 = icmp ult i8 %pix, 85, !dbg !2778      ; [#uses=1 type=i1] [debug line = 23:10]
  br i1 %tmp.29, label %14, label %._crit_edge6, !dbg !2778 ; [debug line = 23:10]

; <label>:14                                      ; preds = %._crit_edge4
  %_shl7 = shl nuw i6 %i.cast1, 4, !dbg !2779     ; [#uses=1 type=i6] [debug line = 23:50]
  %_shl7.cast = zext i6 %_shl7 to i7, !dbg !2779  ; [#uses=1 type=i7] [debug line = 23:50]
  %_shl8 = shl nuw i4 %i.cast2, 2, !dbg !2779     ; [#uses=1 type=i4] [debug line = 23:50]
  %_shl8.cast = zext i4 %_shl8 to i7, !dbg !2779  ; [#uses=1 type=i7] [debug line = 23:50]
  %tmp.30 = sub i7 %_shl7.cast, %_shl8.cast, !dbg !2779 ; [#uses=1 type=i7] [debug line = 23:50]
  %tmp.31 = or i7 %tmp.30, 3, !dbg !2779          ; [#uses=1 type=i7] [debug line = 23:50]
  %tmp.31.cast = sext i7 %tmp.31 to i32, !dbg !2779 ; [#uses=1 type=i32] [debug line = 23:50]
  %tmp.32 = zext i32 %tmp.31.cast to i64, !dbg !2779 ; [#uses=1 type=i64] [debug line = 23:50]
  %rst.addr.4 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.32, !dbg !2779 ; [#uses=2 type=i16*] [debug line = 23:50]
  %rst.load.3 = load i16* %rst.addr.4, align 2, !dbg !2779 ; [#uses=1 type=i16] [debug line = 23:50]
  %tmp.33 = add i16 %rst.load.3, 1, !dbg !2779    ; [#uses=1 type=i16] [debug line = 23:50]
  store i16 %tmp.33, i16* %rst.addr.4, align 2, !dbg !2779 ; [debug line = 23:50]
  br label %29, !dbg !2779                        ; [debug line = 23:50]

._crit_edge6:                                     ; preds = %._crit_edge4
  %tmp.34 = icmp ult i8 %pix, 106, !dbg !2780     ; [#uses=1 type=i1] [debug line = 24:10]
  br i1 %tmp.34, label %15, label %._crit_edge8, !dbg !2780 ; [debug line = 24:10]

; <label>:15                                      ; preds = %._crit_edge6
  %_shl9 = shl nuw i6 %i.cast1, 4, !dbg !2781     ; [#uses=1 type=i6] [debug line = 24:50]
  %_shl9.cast = zext i6 %_shl9 to i7, !dbg !2781  ; [#uses=1 type=i7] [debug line = 24:50]
  %_shl10 = shl nuw i4 %i.cast2, 2, !dbg !2781    ; [#uses=1 type=i4] [debug line = 24:50]
  %_shl10.cast = zext i4 %_shl10 to i7, !dbg !2781 ; [#uses=1 type=i7] [debug line = 24:50]
  %tmp.35 = sub i7 %_shl9.cast, %_shl10.cast, !dbg !2781 ; [#uses=1 type=i7] [debug line = 24:50]
  %tmp.36 = add i7 %tmp.35, 4, !dbg !2781         ; [#uses=1 type=i7] [debug line = 24:50]
  %tmp.36.cast = sext i7 %tmp.36 to i32, !dbg !2781 ; [#uses=1 type=i32] [debug line = 24:50]
  %tmp.37 = zext i32 %tmp.36.cast to i64, !dbg !2781 ; [#uses=1 type=i64] [debug line = 24:50]
  %rst.addr.5 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.37, !dbg !2781 ; [#uses=2 type=i16*] [debug line = 24:50]
  %rst.load.4 = load i16* %rst.addr.5, align 2, !dbg !2781 ; [#uses=1 type=i16] [debug line = 24:50]
  %tmp.38 = add i16 %rst.load.4, 1, !dbg !2781    ; [#uses=1 type=i16] [debug line = 24:50]
  store i16 %tmp.38, i16* %rst.addr.5, align 2, !dbg !2781 ; [debug line = 24:50]
  br label %28, !dbg !2781                        ; [debug line = 24:50]

._crit_edge8:                                     ; preds = %._crit_edge6
  %tmp.39 = icmp sgt i8 %pix, -1, !dbg !2782      ; [#uses=1 type=i1] [debug line = 25:10]
  br i1 %tmp.39, label %16, label %._crit_edge10, !dbg !2782 ; [debug line = 25:10]

; <label>:16                                      ; preds = %._crit_edge8
  %_shl11 = shl nuw i6 %i.cast1, 4, !dbg !2783    ; [#uses=1 type=i6] [debug line = 25:50]
  %_shl11.cast = zext i6 %_shl11 to i7, !dbg !2783 ; [#uses=1 type=i7] [debug line = 25:50]
  %_shl12 = shl nuw i4 %i.cast2, 2, !dbg !2783    ; [#uses=1 type=i4] [debug line = 25:50]
  %_shl12.cast = zext i4 %_shl12 to i7, !dbg !2783 ; [#uses=1 type=i7] [debug line = 25:50]
  %tmp.40 = sub i7 %_shl11.cast, %_shl12.cast, !dbg !2783 ; [#uses=1 type=i7] [debug line = 25:50]
  %tmp.41 = add i7 %tmp.40, 5, !dbg !2783         ; [#uses=1 type=i7] [debug line = 25:50]
  %tmp.41.cast = sext i7 %tmp.41 to i32, !dbg !2783 ; [#uses=1 type=i32] [debug line = 25:50]
  %tmp.42 = zext i32 %tmp.41.cast to i64, !dbg !2783 ; [#uses=1 type=i64] [debug line = 25:50]
  %rst.addr.6 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.42, !dbg !2783 ; [#uses=2 type=i16*] [debug line = 25:50]
  %rst.load.5 = load i16* %rst.addr.6, align 2, !dbg !2783 ; [#uses=1 type=i16] [debug line = 25:50]
  %tmp.43 = add i16 %rst.load.5, 1, !dbg !2783    ; [#uses=1 type=i16] [debug line = 25:50]
  store i16 %tmp.43, i16* %rst.addr.6, align 2, !dbg !2783 ; [debug line = 25:50]
  br label %27, !dbg !2783                        ; [debug line = 25:50]

._crit_edge10:                                    ; preds = %._crit_edge8
  %tmp.44 = icmp ult i8 %pix, -107, !dbg !2784    ; [#uses=1 type=i1] [debug line = 26:10]
  br i1 %tmp.44, label %17, label %._crit_edge12, !dbg !2784 ; [debug line = 26:10]

; <label>:17                                      ; preds = %._crit_edge10
  %_shl13 = shl nuw i6 %i.cast1, 4, !dbg !2785    ; [#uses=1 type=i6] [debug line = 26:50]
  %_shl13.cast = zext i6 %_shl13 to i7, !dbg !2785 ; [#uses=1 type=i7] [debug line = 26:50]
  %_shl14 = shl nuw i4 %i.cast2, 2, !dbg !2785    ; [#uses=1 type=i4] [debug line = 26:50]
  %_shl14.cast = zext i4 %_shl14 to i7, !dbg !2785 ; [#uses=1 type=i7] [debug line = 26:50]
  %tmp.45 = sub i7 %_shl13.cast, %_shl14.cast, !dbg !2785 ; [#uses=1 type=i7] [debug line = 26:50]
  %tmp.46 = add i7 %tmp.45, 6, !dbg !2785         ; [#uses=1 type=i7] [debug line = 26:50]
  %tmp.46.cast = sext i7 %tmp.46 to i32, !dbg !2785 ; [#uses=1 type=i32] [debug line = 26:50]
  %tmp.47 = zext i32 %tmp.46.cast to i64, !dbg !2785 ; [#uses=1 type=i64] [debug line = 26:50]
  %rst.addr.7 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.47, !dbg !2785 ; [#uses=2 type=i16*] [debug line = 26:50]
  %rst.load.6 = load i16* %rst.addr.7, align 2, !dbg !2785 ; [#uses=1 type=i16] [debug line = 26:50]
  %tmp.48 = add i16 %rst.load.6, 1, !dbg !2785    ; [#uses=1 type=i16] [debug line = 26:50]
  store i16 %tmp.48, i16* %rst.addr.7, align 2, !dbg !2785 ; [debug line = 26:50]
  br label %26, !dbg !2785                        ; [debug line = 26:50]

._crit_edge12:                                    ; preds = %._crit_edge10
  %tmp.49 = icmp ult i8 %pix, -86, !dbg !2786     ; [#uses=1 type=i1] [debug line = 27:10]
  br i1 %tmp.49, label %18, label %._crit_edge14, !dbg !2786 ; [debug line = 27:10]

; <label>:18                                      ; preds = %._crit_edge12
  %_shl15 = shl nuw i6 %i.cast1, 4, !dbg !2787    ; [#uses=1 type=i6] [debug line = 27:50]
  %_shl15.cast = zext i6 %_shl15 to i7, !dbg !2787 ; [#uses=1 type=i7] [debug line = 27:50]
  %_shl16 = shl nuw i4 %i.cast2, 2, !dbg !2787    ; [#uses=1 type=i4] [debug line = 27:50]
  %_shl16.cast = zext i4 %_shl16 to i7, !dbg !2787 ; [#uses=1 type=i7] [debug line = 27:50]
  %tmp.50 = sub i7 %_shl15.cast, %_shl16.cast, !dbg !2787 ; [#uses=1 type=i7] [debug line = 27:50]
  %tmp.51 = add i7 %tmp.50, 7, !dbg !2787         ; [#uses=1 type=i7] [debug line = 27:50]
  %tmp.51.cast = sext i7 %tmp.51 to i32, !dbg !2787 ; [#uses=1 type=i32] [debug line = 27:50]
  %tmp.52 = zext i32 %tmp.51.cast to i64, !dbg !2787 ; [#uses=1 type=i64] [debug line = 27:50]
  %rst.addr.8 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.52, !dbg !2787 ; [#uses=2 type=i16*] [debug line = 27:50]
  %rst.load.7 = load i16* %rst.addr.8, align 2, !dbg !2787 ; [#uses=1 type=i16] [debug line = 27:50]
  %tmp.53 = add i16 %rst.load.7, 1, !dbg !2787    ; [#uses=1 type=i16] [debug line = 27:50]
  store i16 %tmp.53, i16* %rst.addr.8, align 2, !dbg !2787 ; [debug line = 27:50]
  br label %25, !dbg !2787                        ; [debug line = 27:50]

._crit_edge14:                                    ; preds = %._crit_edge12
  %tmp.54 = icmp ult i8 %pix, -64, !dbg !2788     ; [#uses=1 type=i1] [debug line = 28:10]
  br i1 %tmp.54, label %19, label %._crit_edge16, !dbg !2788 ; [debug line = 28:10]

; <label>:19                                      ; preds = %._crit_edge14
  %_shl17 = shl nuw i6 %i.cast1, 4, !dbg !2789    ; [#uses=1 type=i6] [debug line = 28:50]
  %_shl17.cast = zext i6 %_shl17 to i7, !dbg !2789 ; [#uses=1 type=i7] [debug line = 28:50]
  %_shl18 = shl nuw i4 %i.cast2, 2, !dbg !2789    ; [#uses=1 type=i4] [debug line = 28:50]
  %_shl18.cast = zext i4 %_shl18 to i7, !dbg !2789 ; [#uses=1 type=i7] [debug line = 28:50]
  %tmp.55 = sub i7 %_shl17.cast, %_shl18.cast, !dbg !2789 ; [#uses=1 type=i7] [debug line = 28:50]
  %tmp.56 = add i7 %tmp.55, 8, !dbg !2789         ; [#uses=1 type=i7] [debug line = 28:50]
  %tmp.57 = zext i7 %tmp.56 to i64, !dbg !2789    ; [#uses=1 type=i64] [debug line = 28:50]
  %rst.addr.9 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.57, !dbg !2789 ; [#uses=2 type=i16*] [debug line = 28:50]
  %rst.load.8 = load i16* %rst.addr.9, align 2, !dbg !2789 ; [#uses=1 type=i16] [debug line = 28:50]
  %tmp.58 = add i16 %rst.load.8, 1, !dbg !2789    ; [#uses=1 type=i16] [debug line = 28:50]
  store i16 %tmp.58, i16* %rst.addr.9, align 2, !dbg !2789 ; [debug line = 28:50]
  br label %24, !dbg !2789                        ; [debug line = 28:50]

._crit_edge16:                                    ; preds = %._crit_edge14
  %tmp.59 = icmp ult i8 %pix, -43, !dbg !2790     ; [#uses=1 type=i1] [debug line = 29:10]
  br i1 %tmp.59, label %20, label %._crit_edge18, !dbg !2790 ; [debug line = 29:10]

; <label>:20                                      ; preds = %._crit_edge16
  %_shl19 = shl nuw i6 %i.cast1, 4, !dbg !2791    ; [#uses=1 type=i6] [debug line = 29:51]
  %_shl19.cast = zext i6 %_shl19 to i7, !dbg !2791 ; [#uses=1 type=i7] [debug line = 29:51]
  %_shl20 = shl nuw i4 %i.cast2, 2, !dbg !2791    ; [#uses=1 type=i4] [debug line = 29:51]
  %_shl20.cast = zext i4 %_shl20 to i7, !dbg !2791 ; [#uses=1 type=i7] [debug line = 29:51]
  %tmp.60 = sub i7 %_shl19.cast, %_shl20.cast, !dbg !2791 ; [#uses=1 type=i7] [debug line = 29:51]
  %tmp.61 = add i7 %tmp.60, 9, !dbg !2791         ; [#uses=1 type=i7] [debug line = 29:51]
  %tmp.62 = zext i7 %tmp.61 to i64, !dbg !2791    ; [#uses=1 type=i64] [debug line = 29:51]
  %rst.addr.10 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.62, !dbg !2791 ; [#uses=2 type=i16*] [debug line = 29:51]
  %rst.load.9 = load i16* %rst.addr.10, align 2, !dbg !2791 ; [#uses=1 type=i16] [debug line = 29:51]
  %tmp.63 = add i16 %rst.load.9, 1, !dbg !2791    ; [#uses=1 type=i16] [debug line = 29:51]
  store i16 %tmp.63, i16* %rst.addr.10, align 2, !dbg !2791 ; [debug line = 29:51]
  br label %23, !dbg !2791                        ; [debug line = 29:51]

._crit_edge18:                                    ; preds = %._crit_edge16
  %tmp.64 = icmp ult i8 %pix, -22, !dbg !2792     ; [#uses=1 type=i1] [debug line = 30:10]
  %_shl21 = shl nuw i6 %i.cast1, 4, !dbg !2793    ; [#uses=1 type=i6] [debug line = 30:52]
  %_shl21.cast = zext i6 %_shl21 to i7, !dbg !2793 ; [#uses=1 type=i7] [debug line = 30:52]
  %_shl22 = shl nuw i4 %i.cast2, 2, !dbg !2793    ; [#uses=1 type=i4] [debug line = 30:52]
  %_shl22.cast = zext i4 %_shl22 to i7, !dbg !2793 ; [#uses=1 type=i7] [debug line = 30:52]
  %tmp.65 = sub i7 %_shl21.cast, %_shl22.cast, !dbg !2793 ; [#uses=2 type=i7] [debug line = 30:52]
  br i1 %tmp.64, label %21, label %._crit_edge20, !dbg !2792 ; [debug line = 30:10]

; <label>:21                                      ; preds = %._crit_edge18
  %tmp.66 = add i7 %tmp.65, 10, !dbg !2793        ; [#uses=1 type=i7] [debug line = 30:52]
  %tmp.67 = zext i7 %tmp.66 to i64, !dbg !2793    ; [#uses=1 type=i64] [debug line = 30:52]
  %rst.addr.11 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.67, !dbg !2793 ; [#uses=2 type=i16*] [debug line = 30:52]
  %rst.load.11 = load i16* %rst.addr.11, align 2, !dbg !2793 ; [#uses=1 type=i16] [debug line = 30:52]
  %tmp.68 = add i16 %rst.load.11, 1, !dbg !2793   ; [#uses=1 type=i16] [debug line = 30:52]
  store i16 %tmp.68, i16* %rst.addr.11, align 2, !dbg !2793 ; [debug line = 30:52]
  br label %22, !dbg !2793                        ; [debug line = 30:52]

._crit_edge20:                                    ; preds = %._crit_edge18
  %tmp.69 = add i7 %tmp.65, 11, !dbg !2794        ; [#uses=1 type=i7] [debug line = 31:10]
  %tmp.70 = zext i7 %tmp.69 to i64, !dbg !2794    ; [#uses=1 type=i64] [debug line = 31:10]
  %rst.addr.12 = getelementptr [36 x i16]* %rst, i64 0, i64 %tmp.70, !dbg !2794 ; [#uses=2 type=i16*] [debug line = 31:10]
  %rst.load.10 = load i16* %rst.addr.12, align 2, !dbg !2794 ; [#uses=1 type=i16] [debug line = 31:10]
  %tmp.71 = add i16 %rst.load.10, 1, !dbg !2794   ; [#uses=1 type=i16] [debug line = 31:10]
  store i16 %tmp.71, i16* %rst.addr.12, align 2, !dbg !2794 ; [debug line = 31:10]
  br label %22

; <label>:22                                      ; preds = %._crit_edge20, %21
  br label %23
...
; <label>:32                                      ; preds = %31, %10
  %33 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @.str13, i32 %tmp.12), !dbg !2795 ; [#uses=0 type=i32] [debug line = 32:4]
  %i.2 = add i2 %i, 1, !dbg !2796                 ; [#uses=1 type=i2] [debug line = 17:33]
  call void @llvm.dbg.value(metadata !{i2 %i.2}, i64 0, metadata !2797), !dbg !2796 ; [debug line = 17:33] [debug variable = i]
  br label %7, !dbg !2796                         ; [debug line = 17:33]

; <label>:34                                      ; preds = %7
  %35 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @.str12, i32 %tmp.11), !dbg !2798 ; [#uses=0 type=i32] [debug line = 33:3]
  %x.1 = add i6 %x, 1, !dbg !2799                 ; [#uses=1 type=i6] [debug line = 16:33]
  call void @llvm.dbg.value(metadata !{i6 %x.1}, i64 0, metadata !2800), !dbg !2799 ; [debug line = 16:33] [debug variable = x]
  br label %4, !dbg !2799                         ; [debug line = 16:33]

; <label>:36                                      ; preds = %4
  %37 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @.str11, i32 %tmp), !dbg !2801 ; [#uses=0 type=i32] [debug line = 34:2]
  %y.1 = add i5 %y, 1, !dbg !2802                 ; [#uses=1 type=i5] [debug line = 15:32]
  call void @llvm.dbg.value(metadata !{i5 %y.1}, i64 0, metadata !2803), !dbg !2802 ; [debug line = 15:32] [debug variable = y]
  br label %1, !dbg !2802                         ; [debug line = 15:32]

; <label>:38                                      ; preds = %1
  ret void, !dbg !2804                            ; [debug line = 35:1]
}
...
; [#uses=1]
declare i8 @_ssdm_op_Mux.ap_auto.16i8.i4(i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i4)
...
!894 = metadata !{i32 786478, i32 0, metadata !895, metadata !"color_hist", metadata !"color_hist", metadata !"_Z10color_histPiPhPt", metadata !895, i32 37, metadata !896, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 37} ; [ DW_TAG_subprogram ]
...
!910 = metadata !{i32 786478, i32 0, metadata !895, metadata !"calc_hist", metadata !"calc_hist", metadata !"_Z9calc_histPA96_hPt", metadata !895, i32 14, metadata !911, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 14} ; [ DW_TAG_subprogram ]
...
!2637 = metadata !{null, metadata !2638, metadata !2639, metadata !2640, metadata !2641, metadata !2642, metadata !2643}
...
!2650 = metadata !{null, metadata !2651, metadata !2652, metadata !2653, metadata !2654, metadata !2655, metadata !2643}
...
!2656 = metadata !{metadata !2657, [1 x i32]* @llvm.global_ctors.0}
!2657 = metadata !{metadata !2658}
!2658 = metadata !{i32 0, i32 31, metadata !2659}
!2659 = metadata !{metadata !2660}
!2660 = metadata !{metadata !"llvm.global_ctors.0", metadata !2661, metadata !"", i32 0, i32 31}
!2661 = metadata !{metadata !2662}
!2662 = metadata !{i32 0, i32 0, i32 1}
!2663 = metadata !{metadata !2664}
!2664 = metadata !{i32 0, i32 31, metadata !2665}
!2665 = metadata !{metadata !2666}
!2666 = metadata !{metadata !"specs", metadata !2667, metadata !"int", i32 0, i32 31}
!2667 = metadata !{metadata !2668}
!2668 = metadata !{i32 0, i32 2, i32 1}
!2669 = metadata !{metadata !2670}
!2670 = metadata !{i32 0, i32 7, metadata !2671}
!2671 = metadata !{metadata !2672}
!2672 = metadata !{metadata !"imageptr", metadata !2661, metadata !"unsigned char", i32 0, i32 7}
!2673 = metadata !{metadata !2674}
!2674 = metadata !{i32 0, i32 15, metadata !2675}
!2675 = metadata !{metadata !2676}
!2676 = metadata !{metadata !"feature", metadata !2661, metadata !"unsigned short", i32 0, i32 15}
!2677 = metadata !{i32 786688, metadata !2678, metadata !"rst", metadata !895, i32 51, metadata !2679, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2678 = metadata !{i32 786443, metadata !894, i32 37, i32 80, metadata !895, i32 0} ; [ DW_TAG_lexical_block ]
!2679 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 576, i64 16, i32 0, i32 0, metadata !165, metadata !2680, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2680 = metadata !{metadata !2681}
!2681 = metadata !{i32 786465, i64 0, i64 35}     ; [ DW_TAG_subrange_type ]
!2682 = metadata !{i32 51, i32 17, metadata !2678, null}
!2683 = metadata !{i32 786689, metadata !894, metadata !"specs", null, i32 37, metadata !2684, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2684 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !56, metadata !2685, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2685 = metadata !{metadata !2686}
!2686 = metadata !{i32 786465, i64 0, i64 2}      ; [ DW_TAG_subrange_type ]
!2687 = metadata !{i32 37, i32 21, metadata !894, null}
!2688 = metadata !{i32 786689, metadata !894, metadata !"imageptr", metadata !895, i32 33554469, metadata !899, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2689 = metadata !{i32 37, i32 46, metadata !894, null}
!2690 = metadata !{i32 786689, metadata !894, metadata !"feature", metadata !895, i32 50331685, metadata !901, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2691 = metadata !{i32 37, i32 72, metadata !894, null}
!2692 = metadata !{i32 39, i32 1, metadata !2678, null}
!2693 = metadata !{i32 40, i32 1, metadata !2678, null}
!2694 = metadata !{i32 41, i32 1, metadata !2678, null}
!2695 = metadata !{i32 42, i32 18, metadata !2678, null}
!2696 = metadata !{i32 786688, metadata !2678, metadata !"y", metadata !895, i32 42, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2697 = metadata !{i32 43, i32 18, metadata !2678, null}
!2698 = metadata !{i32 786688, metadata !2678, metadata !"x", metadata !895, i32 43, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2699 = metadata !{i32 44, i32 31, metadata !2678, null}
!2700 = metadata !{i32 786688, metadata !2678, metadata !"original_width", metadata !895, i32 44, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2701 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[0]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2702 = metadata !{i32 786688, metadata !2678, metadata !"image_buffer", metadata !895, i32 45, metadata !2703, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2703 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 12288, i64 8, i32 0, i32 0, metadata !900, metadata !2704, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2704 = metadata !{metadata !1191, metadata !916}
!2705 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 768, i64 8, i32 0, i32 0, metadata !900, metadata !2704, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2706 = metadata !{i32 45, i32 16, metadata !2678, null}
!2707 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[1]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2708 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[2]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2709 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[3]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2710 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[4]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2711 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[5]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2712 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[6]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2713 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[7]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2714 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[8]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2715 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[9]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2716 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[10]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2717 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[11]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2718 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[12]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2719 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[13]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2720 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[14]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2721 = metadata !{i32 790529, metadata !2702, metadata !"image_buffer[15]", null, i32 45, metadata !2705, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2722 = metadata !{i32 47, i32 26, metadata !2723, null}
!2723 = metadata !{i32 786443, metadata !2678, i32 47, i32 13, metadata !895, i32 1} ; [ DW_TAG_lexical_block ]
!2724 = metadata !{i32 51, i32 32, metadata !2678, null}
!2725 = metadata !{i32 47, i32 41, metadata !2726, null}
!2726 = metadata !{i32 786443, metadata !2723, i32 47, i32 40, metadata !895, i32 2} ; [ DW_TAG_lexical_block ]
!2727 = metadata !{i32 48, i32 50, metadata !2726, null}
!2728 = metadata !{i32 786688, metadata !2726, metadata !"offset", metadata !895, i32 48, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2729 = metadata !{i32 49, i32 3, metadata !2726, null}
!2730 = metadata !{i32 50, i32 2, metadata !2726, null}
!2731 = metadata !{i32 47, i32 36, metadata !2723, null}
!2732 = metadata !{i32 786688, metadata !2723, metadata !"i", metadata !895, i32 47, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2733 = metadata !{i32 52, i32 2, metadata !2678, null}
!2734 = metadata !{i32 53, i32 2, metadata !2678, null}
!2735 = metadata !{i32 54, i32 1, metadata !2678, null}
!2736 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[0]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2737 = metadata !{i32 786689, metadata !910, metadata !"image_buffer", null, i32 14, metadata !2703, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2738 = metadata !{i32 14, i32 37, metadata !910, null}
!2739 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[1]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2740 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[2]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2741 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[3]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2742 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[4]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2743 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[5]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2744 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[6]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2745 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[7]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2746 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[8]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2747 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[9]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2748 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[10]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2749 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[11]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2750 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[12]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2751 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[13]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2752 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[14]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2753 = metadata !{i32 790531, metadata !2737, metadata !"image_buffer[15]", null, i32 14, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2754 = metadata !{i32 786689, metadata !910, metadata !"rst", null, i32 14, metadata !2679, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2755 = metadata !{i32 14, i32 76, metadata !910, null}
!2756 = metadata !{i32 15, i32 22, metadata !2757, null}
!2757 = metadata !{i32 786443, metadata !2758, i32 15, i32 9, metadata !895, i32 5} ; [ DW_TAG_lexical_block ]
!2758 = metadata !{i32 786443, metadata !910, i32 14, i32 88, metadata !895, i32 4} ; [ DW_TAG_lexical_block ]
!2759 = metadata !{i32 15, i32 37, metadata !2760, null}
!2760 = metadata !{i32 786443, metadata !2757, i32 15, i32 36, metadata !895, i32 6} ; [ DW_TAG_lexical_block ]
!2761 = metadata !{i32 16, i32 23, metadata !2762, null}
!2762 = metadata !{i32 786443, metadata !2760, i32 16, i32 10, metadata !895, i32 7} ; [ DW_TAG_lexical_block ]
!2763 = metadata !{i32 16, i32 38, metadata !2764, null}
!2764 = metadata !{i32 786443, metadata !2762, i32 16, i32 37, metadata !895, i32 8} ; [ DW_TAG_lexical_block ]
!2765 = metadata !{i32 19, i32 44, metadata !2766, null}
!2766 = metadata !{i32 786443, metadata !2767, i32 17, i32 37, metadata !895, i32 10} ; [ DW_TAG_lexical_block ]
!2767 = metadata !{i32 786443, metadata !2764, i32 17, i32 11, metadata !895, i32 9} ; [ DW_TAG_lexical_block ]
!2768 = metadata !{i32 17, i32 24, metadata !2767, null}
!2769 = metadata !{i32 17, i32 38, metadata !2766, null}
!2770 = metadata !{i32 18, i32 1, metadata !2766, null}
!2771 = metadata !{i32 786688, metadata !2766, metadata !"pix", metadata !895, i32 19, metadata !900, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2772 = metadata !{i32 20, i32 5, metadata !2766, null}
!2773 = metadata !{i32 20, i32 45, metadata !2766, null}
!2774 = metadata !{i32 21, i32 10, metadata !2766, null}
!2775 = metadata !{i32 21, i32 50, metadata !2766, null}
!2776 = metadata !{i32 22, i32 10, metadata !2766, null}
!2777 = metadata !{i32 22, i32 50, metadata !2766, null}
!2778 = metadata !{i32 23, i32 10, metadata !2766, null}
!2779 = metadata !{i32 23, i32 50, metadata !2766, null}
!2780 = metadata !{i32 24, i32 10, metadata !2766, null}
!2781 = metadata !{i32 24, i32 50, metadata !2766, null}
!2782 = metadata !{i32 25, i32 10, metadata !2766, null}
!2783 = metadata !{i32 25, i32 50, metadata !2766, null}
!2784 = metadata !{i32 26, i32 10, metadata !2766, null}
!2785 = metadata !{i32 26, i32 50, metadata !2766, null}
!2786 = metadata !{i32 27, i32 10, metadata !2766, null}
!2787 = metadata !{i32 27, i32 50, metadata !2766, null}
!2788 = metadata !{i32 28, i32 10, metadata !2766, null}
!2789 = metadata !{i32 28, i32 50, metadata !2766, null}
!2790 = metadata !{i32 29, i32 10, metadata !2766, null}
!2791 = metadata !{i32 29, i32 51, metadata !2766, null}
!2792 = metadata !{i32 30, i32 10, metadata !2766, null}
!2793 = metadata !{i32 30, i32 52, metadata !2766, null}
!2794 = metadata !{i32 31, i32 10, metadata !2766, null}
!2795 = metadata !{i32 32, i32 4, metadata !2766, null}
!2796 = metadata !{i32 17, i32 33, metadata !2767, null}
!2797 = metadata !{i32 786688, metadata !2767, metadata !"i", metadata !895, i32 17, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2798 = metadata !{i32 33, i32 3, metadata !2764, null}
!2799 = metadata !{i32 16, i32 33, metadata !2762, null}
!2800 = metadata !{i32 786688, metadata !2762, metadata !"x", metadata !895, i32 16, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2801 = metadata !{i32 34, i32 2, metadata !2760, null}
!2802 = metadata !{i32 15, i32 32, metadata !2757, null}
!2803 = metadata !{i32 786688, metadata !2757, metadata !"y", metadata !895, i32 15, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2804 = metadata !{i32 35, i32 1, metadata !2758, null}
